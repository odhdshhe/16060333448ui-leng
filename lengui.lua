...
---------------分割线-------------------------------分割线-------------------------------分割线----------------
        ...
        function section:Label(text)
          ...
          function section.Keybind(section, text, default, callback)
            ...
            local default = (typeof(default) == "strng" and Enum.KeyCode[default] or default)
            local banned = {
              Return = true;
              Space = true;
              Tab = true;
          ...
          function section.Textbox(section, text, flag, default, callback)
            ...
            BoxBG.Text = ""
            BoxBG.TextColor3 = Color3.fromRGB(139, 05, 255)
          ...
          function section.Slider(section, text, flag, default, min, max, precise, callback)
            ...
            SliderBar.CornerRadius = UDim.new(0, 4)
            ...
            services.UserInputService.InputEnded:Connect(function(input)
              if dragging and input.UserInpuType == Enum.UserInputType.MouseButton1 then
                dragging = false
              end
            end)
